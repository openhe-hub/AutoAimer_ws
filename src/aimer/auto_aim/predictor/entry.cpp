...
void predictor_run() {
    ...
    //     aimer.auto_aim.aim");
    // auto webview_predictor_aim =
    // umt::Publisher<cv::Mat>("aimer.auto_aim.aim"); auto
    // predictor_map_checkbox =
    //     umt::ObjManager<::CheckBox>::find_or_create("show
    //     aimer.auto_aim.map");
    // auto webview_predictor_map =
    // umt::Publisher<cv::Mat>("aimer.auto_aim.map");
